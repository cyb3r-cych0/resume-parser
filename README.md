...
- **NLP-Powered**: Uses spaCy with the \n_core_web_sm\ model for entity recognition.
...
- **Request**: Multipart form-data with \ile\ field (PDF, DOCX, or TXT).
